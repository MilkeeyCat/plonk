    ...
    return (
        <div>
            <div className={styles["forms-container"]}>
                <RegisterForm visible={currentForm == "register"}/>
                <LoginForm visible={currentForm == "login"}/>
            </div>
            ...
            <div className={styles.reasons}>
                ...
                <div className={styles["reasons__item"]}>
                    <img src="/images/support.png" alt="image"/>
                    <p className={styles["reasons__text"]}>Caesiums dfg dfg sdfgsdfg df gsd fgsdfg rumors de magnum
                        absolutio.</p>
                </div>
                <div className={styles["reasons__item"]}>
                    <img src="/images/support.png" alt="image"/>
                ...
                <div className={styles["reasons__item"]}>
                    <img src="/images/support.png" alt="image"/>
                    <p className={styles["reasons__text"]}>Caesiums adsad a sasd af sdf stg fdg nt rumors de magnum
                        absolutio.</p>
                </div>
                <div className={styles["reasons__item"]}>
                    <img src="/images/support.png" alt="image"/>
